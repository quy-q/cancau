            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tbody>
                    @foreach ($categoryp as $item)
                  <tr>
                    <td>{{$item->idc}}</td>
                    <td>{{$item->NameC}}</td>
                    <td>{{$item->DesC}}</td>
                    <td><a class="btn btn-success" href="/admin/cateAdmin/editCate/{{$item->idc}}">Sửa</a><a class="btn btn-danger" href="/admin/cateAdmin/deleteC/{{$item->idc}}">Xóa</a></td>
                  </tr>     
                  @endforeach 
                  </tbody>
                </table>
